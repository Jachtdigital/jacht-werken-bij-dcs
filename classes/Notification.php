...
if (!class_exists(__NAMESPACE__ . '\\Notification', false)) {
    ...
    class Notification
    {
        ...
        public const DISMISS_PER_USER = 'user';
        public const DISMISS_PER_SITE = 'site';
        public const DISMISS_PERMANENTLY = 3153600000; //100 years in seconds.
        public const DISMISS_ACTION_PREFIX = 'ye_v1_dismiss-';

        public const DISMISSED_OPTION_PREFIX = 'ye_is_dismissed-';
        public const DELAYED_NOTICE_OPTION = 'ye_delayed_notices';
        ...
        protected static function tryUnserializeNotice($json)
        {
            ...
            if (self::getKey($properties, '_className') !== static::class) {
                return null;
            }
        ...
        public function undismiss($scope = self::DISMISS_PER_SITE)
        {
            ...
            } else if ($scope === self::DISMISS_PER_SITE) {
        ...
        public static function _ajaxAddDismissalHandler()
        {
            ...
            $ajaxNonce = (string)$_POST['_ajax_nonce'];
            $json = (string)wp_unslash($_POST['notice-data']);
        ...
        protected static function isUnhandledAjaxAction()
        {
            ...
            return self::stringStartsWith($action, self::DISMISS_ACTION_PREFIX)
     ...
     * @return Notification
     */
    function easyNotification($id = null)
    {
        return new Notification($id);
    }

    if (function_exists('add_action')) {
        add_action('admin_notices', array(__NAMESPACE__ . '\\Notification', '_showDelayedNotices'));
        add_action('admin_init', array(__NAMESPACE__ . '\\Notification', '_ajaxAddDismissalHandler'), 300);
    }
